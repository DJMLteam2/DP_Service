...
model_path = os.path.join(current_dir, 'python/travel_model_v5.pkl')
info_path = os.path.join(current_dir, 'python/DB_INFO.pkl')
...
def getAnswer(question: Question):
    ...
    food_city_df = food_df[food_df['SPOT_CITY']== question.area]
    spot_city_df = spot_df[spot_df['SPOT_CITY']== question.area]
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("dapp:app", host="0.0.0.0", port=4000, workers=4)